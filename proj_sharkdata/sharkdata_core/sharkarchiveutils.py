...
#         if self._zip is None:
#             self.open()    
#         if 'shark_data.txt' not self._zip.namelist():
#             raise UserWarning('The entry shark_data.txt is missing in ' + self._filepathname')
#         #    
#         return self._zip.open('shark_data.txt', 'r')
            ...
            for index, row in enumerate(zip.open('shark_data.txt').readlines()):
                ...
                if index == 0:
                    ...
                    for item_index, item in enumerate(header):
                        ...
                        if item in ['sampling_date', 'visit_date']: date_index = item_index
                        if item in ['latitude_dd', 'lat_dd']: latitude_index = item_index
                        if item in ['longitude_dd', 'long_dd']: longitude_index = item_index
                        if item in ['parameter']: parameter_index = item_index
                        if item in ['unit']: unit_index = index
                        #
    ...
    def update(self):
        ...
        for root, dirs, files in os.walk(self._archive_path):
            for filename in files:
                if filename.startswith('SHARK') and \
                   ('version' in filename) and \
...
#     """ """
#     archive = SharkArchive('/home/parallels/Desktop/SHARK_FTP/datasets')
...
#         print(version)
#          
#     print('--- List shark-metadata-auto ---') 
#      
#     zipreader = SharkArchiveFileReader('SHARK_Speciesobs_2010_Zooplankton_version_TEST2013-11-10.zip', 
#                                        '/home/parallels/Desktop/SHARK_FTP/datasets')
#     try:
#         zipreader.open()
...
#         zipreader.close()
#         
#     print('--- Calculate shark-metadata-auto ---') 
#     
#     zipwriter = SharkArchiveFileWriter('SHARK_Speciesobs_2010_Zooplankton_version_TEST2013-11-10.zip', 
#                                        '/home/parallels/Desktop/SHARK_FTP/datasets')
#     zipwriter.generateMetadataAuto()
#       
#     zipwriter = SharkArchiveFileWriter('SHARK_Speciesobs_2011_Zooplankton_version_TEST2013-11-10.zip', 
#                                        '/home/parallels/Desktop/SHARK_FTP/datasets')
#     zipwriter.generateMetadataAuto()
#       
#     zipwriter = SharkArchiveFileWriter('SHARK_Speciesobs_2012_Zooplankton_version_TEST2013-11-10.zip', 
#                                        '/home/parallels/Desktop/SHARK_FTP/datasets')
#     zipwriter.generateMetadataAuto()
#       
#     print('-----') 
